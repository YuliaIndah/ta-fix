...
class Man_sarprasC extends CI_Controller {
	...
	//export ke dalam format excel
      public function export_excel(){
           $data = array( 'title' => 'Data RAB',
                		  'data_rab' => $this->Man_sarprasM->data_rab_all(),
                		  'Man_sarprasM' => $this->Man_sarprasM);
 							
           $this->load->view('excel_content',$data);
      }
    ...
    // Settingan awal fil excel
		$excel->getProperties()->setCreator('Manajer Sarana dan Prasarana')
		->setLastModifiedBy('Manajer')
		->setTitle("Data Pengajuan RAB")
		->setSubject("RAB")
		->setDescription("Data Pengajuan RAB Barang")
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA RAB"); // Set kolom A1 dengan tulisan "DATA SISWA"
    ...
    $data = $this->Man_sarprasM->data_rab_all();
    ...
    foreach($data as $data){ // Lakukan looping pada variabel siswa
    	...
    	$excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data->nama_pengaju);
    ...
    $excel->getActiveSheet(0)->setTitle("DATA RAB");
