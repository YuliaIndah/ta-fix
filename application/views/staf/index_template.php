...
<body>
  ...
  <section id="container" class="">
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Staf <span class="lite"><?php echo $data_diri->nama_unit;?></span></a>
      <!--logo end-->
      ...
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu">                
          ...
          <!-- <li class="sub-menu">
            ...
            <ul class="sub">
              <li> <a href="<?php echo site_url('StafC/persetujuan_kegiatan_mahasiswa')?>">Kegiatan Mahasiswa</a></li>
            </ul>
          </li> -->
          <li>
            <a href="<?php echo site_url('StafC/pengajuan_kegiatan')?>">
              <i class="icon_ol"></i>
      ...
      $(document).ready(function(){
        $('#modal_progress').on('show.bs.modal', function (e) {
          var rowid = $(e.relatedTarget).data('id');
            ...
            $.ajax({
              type : 'get',
              url : '<?php echo base_url().'StafC/detail_progress/'?>'+rowid,
