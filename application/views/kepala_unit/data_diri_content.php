    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url('Kepala_unitC/edit_data_diri')."/".$data_diri->no_identitas?>" method="post" enctype="multipart/form-data" role="form">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel-body">
              <?php echo form_open_multipart('Kepala_unitC/upload_image');?>
              <form role="form" action="<?php echo base_url(); ?>Kepala_unitC/upload_image" method="post">
                <div style="color: red;"><?php echo (isset($message))? $message : ""; ?></div>
                <div class="form-group">
