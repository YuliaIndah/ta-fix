...
<body>
  ...
  <section id="container" class="">
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Kepala <span class="lite"><?php echo $data_diri->nama_unit;?></span></a>
      <!--logo end-->
          ...
          <li class="dropdown">
           ...
           <ul class="dropdown-menu extended logout">
            ...
            <li class="eborder-top">
              <a href="<?php echo site_url('Kepala_unitC/data_diri')?>"><i class="icon_profile"></i> Data Diri</a>
            </li>
            <li>
              <a href="<?php echo site_url('Kepala_unitC/pengaturan_akun')?>"><i class="icon_cogs"></i> Pengaturan Akun</a>
            </li>
            <li>
  ...
  <aside>
    <div id="sidebar"  class="nav-collapse ">
      ...
      <ul class="sidebar-menu">                
        <li>
          <a href="<?php echo site_url('Kepala_unitC/')?>">
      ...
      $(function() {
        ...
        $(document).ready(function(){
          $('#modal_progress').on('show.bs.modal', function (e) {
            ...
            $.ajax({
              type : 'get',
              url : '<?php echo base_url().'Kepala_unitC/detail_progress/'?>'+rowid,
