...
<body>
  ...
  <section id="container" class="">
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Mahasiswa </a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu">                
          <li>
            <a href="<?php echo site_url('MahasiswaC/')?>">
              <i class="icon_house_alt"></i>
              <span>Beranda</span>
            </a>
          </li>
          <li>
            <a href="<?php echo site_url('MahasiswaC/pengajuan_kegiatan')?>">
              <i class="icon_ol"></i>
       ...
       $(document).ready(function(){
        $('#modal_progress').on('show.bs.modal', function (e) {
          var rowid = $(e.relatedTarget).data('id');
            ...
            $.ajax({
              type : 'get',
              url : '<?php echo base_url().'MahasiswaC/detail_progress/'?>'+rowid,
