            ...
            <div class="table-responsive">
              ...
              <tbody>
                ...
                foreach ($data_pengajuan_kegiatan as $kegiatan) {
                 $jabatan        = $Man_keuanganM->get_data_pengajuan_by_id($kegiatan->kode_kegiatan)->result()[0];
                 $unit           = $Man_keuanganM->get_data_pengajuan_by_id($kegiatan->kode_kegiatan)->result()[0];
                 ?>
                 <tr>
