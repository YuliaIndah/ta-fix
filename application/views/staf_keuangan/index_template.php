...
<body>
  ...
  <section id="container" class="">
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Staf <span class="lite">Keuangan</span></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li class="eborder-top">
                <a href="<?php echo site_url('Staf_keuanganC/data_diri')?>"><i class="icon_profile"></i> Data Diri</a>
              </li>
              <li>
                <a href="<?php echo site_url('Staf_keuanganC/pengaturan_akun')?>"><i class="icon_cogs"></i> Pengaturan Akun</a>
              </li>
              <li>
    ...
    <aside>
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu">                
          <li>
            <a href="<?php echo site_url('Staf_keuanganC/')?>">
          ...
          <!-- <li class="sub-menu">
            ...
            <ul class="sub">
              <li> <a href="<?php echo site_url('Staf_keuanganC/persetujuan_kegiatan_mahasiswa')?>">Kegiatan Mahasiswa</a></li>
            </ul>
          </li> -->
          <li>
            <a href="<?php echo site_url('Staf_keuanganC/pengajuan_kegiatan')?>">
              <i class="icon_ol"></i>
      ...
      $(document).ready(function(){
        $('#modal_progress').on('show.bs.modal', function (e) {
          var rowid = $(e.relatedTarget).data('id');
            ...
            $.ajax({
              type : 'get',
              url : '<?php echo base_url().'Staf_keuanganC/detail_progress/'?>'+rowid,
