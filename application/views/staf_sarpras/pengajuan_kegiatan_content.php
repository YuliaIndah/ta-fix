      ...
      <div class="modal-content">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php echo form_open_multipart('Staf_sarprasC/post_pengajuan_kegiatan_pegawai');?>
            <form role="form" action="<?php echo base_url(); ?>Staf_sarprasC/post_pengajuan_kegiatan_pegawai" method="post">
              <!-- Alert -->
              <!-- sampai sini -->
