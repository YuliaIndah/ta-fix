                ...
                <tbody>
                  ...
                  <td><center>
                    ...
                    <div class="btn-group">
                      ...
                      <a href="<?php echo base_url('Man_sarprasC/post_persetujuan_tersedia/'.$barang->kode_item_pengajuan);?>" id="custId" data-toggle="tooltip" data-toggle="tooltip" title="tersedia" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-briefcase"></span></a>
                    </div>
                    <?php
                  }else{
                    echo "selesai";
